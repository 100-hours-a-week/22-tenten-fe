...
export default function MessageInput() {
  ...
  return (
    <form
      className="flex gap-2 sticky w-full max-w-[480px] border-t-[1px] border-textOpacity50 mb-16 mx-auto lg:self-start bg-bgColor text-textColor shadow-md items-center"
      onSubmit={(e) => {
        e.preventDefault();
        handleSubmit();
      }}
