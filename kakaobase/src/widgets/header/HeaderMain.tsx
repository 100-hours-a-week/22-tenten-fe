...
export default function HeaderMain() {
  return (
    <div className="flex stickty z-30 py-2 gap-2 px-6 items-center w-full max-w-[480px] border-textOpacity50 border-b-[1px] top-0 mx-auto lg:self-start bg-bgColor text-textColor shadow-sm">
